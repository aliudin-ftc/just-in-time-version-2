...
<button onClick="location.href='<?php echo base_url(); ?>resources/vendor/add';" title="Add New Customer" class="btn btn-float theme-bg-1 m-btn waves-effect waves-circle waves-float">
