<section id="content">
    <div class="container">
        ...
        <div class="card inner-layer p-b-13">
            ...
            <table id="brand-table" class="table table-striped table-vmiddle m-b-10">
                <thead>
                    <tr>
...
<button onClick="location.href='<?php echo base_url(); ?>maintenance/brand/add';" title="Add New Brand" class="btn btn-float theme-bg-1 m-btn waves-effect waves-circle waves-float">
