<section id="content">
    <div class="container">
        ...
        <div class="card inner-layer p-b-13">
            ...
            <table id="department-table" class="table table-striped table-vmiddle m-b-10">
                <thead>
                    <tr>
...
<button onClick="location.href='<?php echo base_url(); ?>maintenance/department/add';" title="Add New Department" class="btn btn-float theme-bg-1 m-btn waves-effect waves-circle waves-float">
