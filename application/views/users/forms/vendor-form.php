...
<div class="row">
    <div class="col-sm-4">
        <div class="form-group required">
            ...
            <div class="fg-line">
                <?php echo form_input($input['vendor_fname']); ?>
            </div>
    ...
    <div class="col-sm-4">
        <div class="form-group required">
            ...
            <div class="fg-line">
                <?php echo form_input($input['vendor_mname']); ?>
            </div>
            <small class="help-block"></small>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group required">
            ...
            <div class="fg-line">
                <?php echo form_input($input['vendor_lname']); ?>
            </div>
            <small class="help-block"></small>
        </div>
    </div>
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <div class="fg-line">
                <?php echo form_input($input['vendor_account']); ?>
            </div>
            <small class="help-block"></small>
        </div>
    </div>
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <div class="fg-line">
                <?php echo form_input($input['vendor_purchase_code']); ?>
            </div>
            <small class="help-block"></small>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <div class="fg-line">
                <?php echo form_input($input['vendor_shipment_method']); ?>
            </div>
            <small class="help-block"></small>
        </div>
    </div>
