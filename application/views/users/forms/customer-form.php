...
<div class="row">
    <div class="col-sm-4">
        <div class="form-group">
            <label class="f-500 m-b-5 c-black">Phone Number</label>
            <div class="fg-line">
                <?php echo form_input($input['contact_phone_number']); ?>
            </div>
            <small class="help-block"></small>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group required">
            <label class="f-500 m-b-5 c-black">Mobile Number</label>
            <div class="fg-line">
                <?php echo form_input($input['contact_mobile_number']); ?>
            </div>
            <small class="help-block"></small>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
            <label class="f-500 m-b-5 c-black">Fax Number</label>
            <div class="fg-line">
                <?php echo form_input($input['contact_fax_number']); ?>
            </div>
            <small class="help-block"></small>
        </div>
    </div>
