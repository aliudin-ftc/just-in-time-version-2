...
<div class="row">
    <div class="col-sm-4">
        <div class="form-group required">
            ...
            <div class="fg-line">
                <?php echo form_input($input['contractor_fname']); ?>
            </div>
    ...
    <div class="col-sm-4">
        <div class="form-group required">
            ...
            <div class="fg-line">
                <?php echo form_input($input['contractor_mname']); ?>
            </div>
            <small class="help-block"></small>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group required">
            ...
            <div class="fg-line">
                <?php echo form_input($input['contractor_lname']); ?>
            </div>
            <small class="help-block"></small>
        </div>
    </div>
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <div class="fg-line">
                <?php echo form_input($input['contractor_account']); ?>
            </div>
            <small class="help-block"></small>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group required">
            <label class="f-500 m-b-5 c-black">Payment Terms</label>
            <?php 
                echo 
                    form_dropdown(
                        $input['payment_terms_attributes'],
                        $input['payment_terms_options'],
                        $input['payment_terms_selected']
                    ); 
            ?>
            <small class="help-block"></small>
        </div>
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            <label class="f-500 m-b-5 c-black">Purchase Code</label>
            <div class="fg-line">
                <?php echo form_input($input['contractor_purchase_code']); ?>
            </div>
            <small class="help-block"></small>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
            <label class="f-500 m-b-5 c-black">Shipment Method</label>
            <div class="fg-line">
                <?php echo form_input($input['contractor_shipment_method']); ?>
            </div>
            <small class="help-block"></small>
        </div>
    </div>
