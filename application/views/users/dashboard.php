    ...
    <div class="container">
        ...
        <div id="c-grid" class="clearfix" data-columns>
            ...
            <div class="card popular-post">
                <div class="card-header ch-img" style="background-image: url(<?php echo base_url('assets/public/img/headers/4.png'); ?>); height: 150px;">
            ...
            <div class="card c-dark palette-Grey bg recent-signups">
                ...
                <div class="card-body">
                    ...
                    <ul class="rs-list">
                        ...
                        <li>
                            <a href="">
                                <img class="avatar-img" src="<?php echo base_url('assets/public/img/profile-pics/9.jpg'); ?>" alt="">
                            </a>
                        </li>
                        <li>
                            <a href="">
                        ...
                        <li>
                            <a href="">
                                <img class="avatar-img" src="<?php echo base_url('assets/public/img/profile-pics/7.jpg'); ?>" alt="">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img class="avatar-img" src="<?php echo base_url('assets/public/img/profile-pics/6.jpg'); ?>" alt="">
                            </a>
                        </li>
                        <li>
                            <a href="">
                                <img class="avatar-img" src="<?php echo base_url('assets/public/img/profile-pics/8.jpg'); ?>" alt="">
                            </a>
                        </li>
                        <li>
                            <a href="">
            ...
            <div class="card">
                <div class="card-header ch-img" style="background-image: url(<?php echo base_url('assets/public/img/demo/note.png'); ?>); height: 250px;"></div>
                <div class="card-header">
                    <h2>
