        ...
        <form id="resources-form" method="post" enctype="multipart/form-data">
            ...
            <div class="card inner-layer">
                ...
                <div class="card-body card-padding p-b-13">
                    <?php $this->load->view('users/forms/vendor-form'); ?>               
                </div>
            </div> 
        </form>  
...
<button onClick="location.href='<?php echo base_url(); ?>resources/vendor/manage';" id="back-vendor-btn" title="Back to Manage vendors"  class="btn btn-float theme-bg-2 m-btn d-btn waves-effect waves-circle waves-float">
    <i class="zmdi zmdi-arrow-left"></i>
</button>

<button id="save-resources-btn" title="Save vendor"  class="btn btn-float theme-bg-1 m-btn waves-effect waves-circle waves-float">
