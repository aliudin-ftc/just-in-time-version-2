        ...
        <form id="resources-form" method="post" enctype="multipart/form-data">
            ...
            <div class="card inner-layer">
                ...
                <div class="card-body card-padding p-b-13">
                    <?php $this->load->view('users/forms/contractor-form'); ?>               
                </div>
            </div> 
        </form>  
            ...
            <div class="card p-b-13">
                <div class="card-header">
                    ...
                    <button id="address-line-button" data-toggle="modal" href="#address-line-modal" class="pull-right btn theme-bg-1 waves-effect hidden">
                        Add New
                    </button>                           
                </div>
                <div class="card-body">
            ...
            <div class="card p-b-13">
                <div class="card-header">
                    ...
                    <button id="contact-line-button" data-toggle="modal" href="#contact-line-modal" class="pull-right btn theme-bg-1 waves-effect hidden">
                        Add New
                    </button>                           
                </div>
                <div class="card-body">
            ...
            <div class="card p-b-13">
                <div class="card-header">
                    ...
                    <button id="outgoing-line-button" data-toggle="modal" href="#outgoing-line-modal" class="pull-right btn theme-bg-1 waves-effect hidden">
                        Add New
                    </button>                           
                </div>
                <div class="card-body">
...
<button onClick="location.href='<?php echo base_url(); ?>resources/contractor/manage';" id="back-contractor-btn" title="Back to Manage contractors"  class="btn btn-float theme-bg-2 m-btn d-btn waves-effect waves-circle waves-float">
    <i class="zmdi zmdi-arrow-left"></i>
</button>

<button id="save-resources-btn" title="Save contractor"  class="btn btn-float theme-bg-1 m-btn waves-effect waves-circle waves-float">
