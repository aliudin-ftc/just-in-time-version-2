...
class Template
{
	...
	public function build($view, $data = array(), $return = FALSE)
	{
		...
		$template['title']	= $this->_title;
                $template['sub_title']	= $this->_sub_title;
	...
	public function sub_title()
	{
		...
		{
			$title_segments = func_get_args();
			$this->_sub_title = implode($this->_sub_title_separator, $title_segments);
		}
