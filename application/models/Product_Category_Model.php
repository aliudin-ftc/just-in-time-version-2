...
class Product_Category_Model extends CI_Model {
    ...
    {   
        $this->db->select('*');
        $this->db->from($this->product_categoryTable.' as product_category');
        $this->db->join('job_order as job','product_category.product_category_id = job.product_category_id');    
    ...
    {   
        ...
        {   
            ...
            $this->db->join('job_elements as job', 'prod.product_category_id = job.product_category_id');
